...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LD1_B_Pin|LD1_R_Pin|LD1_G_Pin|LD2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_2, GPIO_PIN_RESET);

  /*Configure GPIO pins : LD1_B_Pin LD1_R_Pin LD1_G_Pin LD2_Pin */
  GPIO_InitStruct.Pin = LD1_B_Pin|LD1_R_Pin|LD1_G_Pin|LD2_Pin;
