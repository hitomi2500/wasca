...
void video_vdp1_init(video_screen_mode_t screen_mode)
{
    ...
    //-------------- setup VDP1 -------------------
    //setting up a small VDP1 list with 5 commands: sys clip, local coords, text sprite, shadowdrop sprite, end
    ...
    //quad for text, always 320x224 and always centered, same resolution for all videomodes
