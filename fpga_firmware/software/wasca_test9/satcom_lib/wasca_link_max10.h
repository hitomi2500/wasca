/**
 *  Wasca Link - PC <-> Nios link related definition
 *  by cafe-alpha.
...
#ifndef WASCA_LINK_MAX10_H
#define WASCA_LINK_MAX10_H

#include "wasca_link_base.h"
#include "wasca_link_spi.h"
...
} SC_ALIGN_4_BYTES(wl_nios_verinfo_t);
