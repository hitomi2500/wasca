...
--synthesis_resources = 
 ...
 ENTITY  wasca_mm_interconnect_0_router IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END wasca_mm_interconnect_0_router;

 ARCHITECTURE RTL OF wasca_mm_interconnect_0_router IS
 ...
 BEGIN
	...
	src_data <= ( sink_data(87 DOWNTO 75) & "0" & "0" & "1" & sink_data(71 DOWNTO 0));
	src_endofpacket <= sink_endofpacket;
	src_startofpacket <= sink_startofpacket;
	src_valid <= sink_valid;

 END RTL; --wasca_mm_interconnect_0_router
