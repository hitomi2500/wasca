...
--synthesis_resources = 
 ...
 ENTITY  wasca_mm_interconnect_0_cmd_mux_003 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END wasca_mm_interconnect_0_cmd_mux_003;

 ARCHITECTURE RTL OF wasca_mm_interconnect_0_cmd_mux_003 IS
