...
--synthesis_resources = 
 ...
 ENTITY  wasca_mm_interconnect_0_cmd_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END wasca_mm_interconnect_0_cmd_demux;

 ARCHITECTURE RTL OF wasca_mm_interconnect_0_cmd_demux IS
 ...
 END RTL; --wasca_mm_interconnect_0_cmd_demux
