...
module wasca_mm_interconnect_0 (
	...
	wire  [107:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> audio_0_avalon_audio_slave_agent:cp_data
	...
	wire  [107:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> onchip_flash_0_data_agent:cp_data
	...
	wire  [107:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> uart_0_s1_agent:cp_data
	...
	wire  [108:0] spi_sd_card_spi_control_port_agent_rf_source_data;                                  // spi_sd_card_spi_control_port_agent:rf_source_data -> spi_sd_card_spi_control_port_agent_rsp_fifo:in_data
	...
	wire  [108:0] spi_sd_card_spi_control_port_agent_rsp_fifo_out_data;                               // spi_sd_card_spi_control_port_agent_rsp_fifo:out_data -> spi_sd_card_spi_control_port_agent:rf_sink_data
	...
	wire  [107:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> spi_sd_card_spi_control_port_agent:cp_data
	...
	wire  [108:0] spi_stm32_spi_control_port_agent_rf_source_data;                                    // spi_stm32_spi_control_port_agent:rf_source_data -> spi_stm32_spi_control_port_agent_rsp_fifo:in_data
	...
	wire  [108:0] spi_stm32_spi_control_port_agent_rsp_fifo_out_data;                                 // spi_stm32_spi_control_port_agent_rsp_fifo:out_data -> spi_stm32_spi_control_port_agent:rf_sink_data
	...
	wire  [107:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> spi_stm32_spi_control_port_agent:cp_data
	...
	wire  [107:0] audio_0_avalon_audio_slave_agent_rp_data;                                           // audio_0_avalon_audio_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [107:0] onchip_flash_0_data_agent_rp_data;                                                  // onchip_flash_0_data_agent:rp_data -> router_005:sink_data
	...
	wire  [107:0] uart_0_s1_agent_rp_data;                                                            // uart_0_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [107:0] spi_sd_card_spi_control_port_agent_rp_data;                                         // spi_sd_card_spi_control_port_agent:rp_data -> router_010:sink_data
	...
	wire          spi_stm32_spi_control_port_agent_rp_valid;                                          // spi_stm32_spi_control_port_agent:rp_valid -> router_011:sink_valid
	wire  [107:0] spi_stm32_spi_control_port_agent_rp_data;                                           // spi_stm32_spi_control_port_agent:rp_data -> router_011:sink_data
	wire          spi_stm32_spi_control_port_agent_rp_ready;                                          // router_011:sink_ready -> spi_stm32_spi_control_port_agent:rp_ready
	wire          spi_stm32_spi_control_port_agent_rp_startofpacket;                                  // spi_stm32_spi_control_port_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire          spi_stm32_spi_control_port_agent_rp_endofpacket;                                    // spi_stm32_spi_control_port_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire  [107:0] abus_avalon_sdram_bridge_0_avalon_sdram_rsp_width_adapter_src_data;                 // abus_avalon_sdram_bridge_0_avalon_sdram_rsp_width_adapter:out_data -> rsp_demux_002:sink_data
	...
	wire    [9:0] abus_avalon_sdram_bridge_0_avalon_sdram_rsp_width_adapter_src_channel;              // abus_avalon_sdram_bridge_0_avalon_sdram_rsp_width_adapter:out_channel -> rsp_demux_002:sink_channel
	...
	wire  [107:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> abus_avalon_sdram_bridge_0_avalon_sdram_cmd_width_adapter:in_data
	wire          cmd_mux_002_src_ready;                                                              // abus_avalon_sdram_bridge_0_avalon_sdram_cmd_width_adapter:in_ready -> cmd_mux_002:src_ready
	wire    [9:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> abus_avalon_sdram_bridge_0_avalon_sdram_cmd_width_adapter:in_channel
	...
	wasca_mm_interconnect_0_router_002 router_011 (
