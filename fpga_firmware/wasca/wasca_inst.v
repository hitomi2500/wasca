	wasca u0 (
		...
		.sd_card_spi_external_MISO                   (<connected-to-sd_card_spi_external_MISO>),                   //           sd_card_spi_external.MISO
		.sd_card_spi_external_MOSI                   (<connected-to-sd_card_spi_external_MOSI>),                   //                               .MOSI
		.sd_card_spi_external_SCLK                   (<connected-to-sd_card_spi_external_SCLK>),                   //                               .SCLK
		.sd_card_spi_external_SS_n                   (<connected-to-sd_card_spi_external_SS_n>),                   //                               .SS_n
