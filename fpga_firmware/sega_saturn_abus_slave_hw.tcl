...
add_interface_port abus abus_address address Input 26
...
add_interface_port abus abus_functioncode functioncode Input 2
add_interface_port abus abus_timing timing Input 3
add_interface_port abus abus_waitrequest waitrequest Output 1
add_interface_port abus abus_addressstrobe addressstrobe Input 1
add_interface_port abus abus_interrupt interrupt Input 1
add_interface_port abus abus_readdata readdata Output 16
add_interface_port abus abus_writedata writedata Input 16
...
add_interface_port avalon_master avalon_address address Output 26
